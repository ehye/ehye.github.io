...
或者直接到openwrt官网[查找固件](https://openwrt.org/toh/views/toh_fwdownload)
...
使用 telnet 登陆到路由器，浏览器打开网址 http://192.168.1.1/setup.cgi?todo=debug, 用户名密码默认 admin password. 这时你应该会看到  "Debug Enabled!" 字样，启用Telnet成功。

进入到U盘文件夹。mtd命令刷入bootloader
```
...
在国内就用清华的
```
src/gz base https://mirrors.tuna.tsinghua.edu.cn/lede/releases/18.06.1/packages/mipsel_24kc/base
src/gz luci https://mirrors.tuna.tsinghua.edu.cn/lede/releases/18.06.1/packages/mipsel_24kc/luci
src/gz routing https://mirrors.tuna.tsinghua.edu.cn/lede/releases/18.06.1/packages/mipsel_24kc/routing
src/gz packages https://mirrors.tuna.tsinghua.edu.cn/lede/releases/18.06.1/packages/mipsel_24kc/packages
