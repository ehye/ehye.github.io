...
**模型**。给定一个 n 乘 n 的网格，每块以概率 p 打开，当且仅当顶部到底部被打开的块相连接时，这个系统为渗流的

<!-- | 渗流 | 不渗流 |
| :----: | :----:|
|<img src="./percolates-yes.png" width="314" height="246" />|<img src="./percolates-no.png" width="327" height="256" />| -->
...
<img src="./percolation-threshold20.png" width="357" height="257" />
